...
class Constants(BaseConstants):
    name_in_url = 'end_questions_coopetition'
...
SURVEY_DEFINITIONS = (
    {
        ...
        'survey_fields': [
            ('strategies',
             {
                 'text': 'What strategy did you use for the Investment Task (the task you just finished)? Does it change from Part 1 to Part 2?',
    ...
    },
    {
        'page_title': '',
        'form_help_initial': """
            <p>Before we end, please answer some questions.</p>""",
        'survey_fields': [
            ('difficulty',
             {
...
Player = create_player_model_for_survey('end_questions_coopetition.models', SURVEY_DEFINITIONS,
            other_fields={})
