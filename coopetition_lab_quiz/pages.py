...
class SomeUnderstandingQuestions(UnderstandingQuestionsPage):
    ...
    def get_questions(self):
        if self.session.config['language'] != 'CN':
        ...
        #         questions = [
        #             {
        #                 'question': '[True/False] 你和你的对手投入越多的资源投入到投资账户，你们的合作总收益就会越高。The more you and the other participant invest in the Investment Account, the higher the total return.',
        #                 'options': ['True', 'False'],
        #                 'correct': 'True',
        #             },
        #             {
        #                 'question': '[True/False] 你投入越多的资源到分配账户，你所获得的合作总收益的份额就越高。The more you invest in the Rationing Account, the higher share you can obtain from the total return of the Investment Account',
        #                 'options': ['True', 'False'],
        #                 'correct': 'True',
        #             },
        #             {
        #                 'question': '每期开始时，你和你的对手各自获得10份资源. 如果你投入10份资源到投资账户(\(x_1=10, y_1=0\))而你的对手将10份资源个人保留(\(x_2=0, y_2=0\)). 你们的合作总收益是多少? At the start of a round, you and the other participant each receive 10 points. Suppose you put 10 points in the Investment Account, while the other keeps these 10 points for himself (\(x_1=10, y_1=0\) and \(x_2=0, y_2=0\)). What is the total return from the Investment Account?',
        #                 'options': ['0', '10', '20', '100'],
        #                 'correct': '0',
        #             },
        #             {
        #                 'question': '每期开始时，你和你的对手各自获得10份资源. 如果你和你的对手都投入10份资源到投资账户(\(x_1=x_2=10, y_1=y_2=0\)), 你们的合作总收益是多少? At the start of a round, you and the other participant each receive 10 points. Suppose both of you put all the 10 points in the Investment Account (\(x_1=x_2=10\)). What is the total return from the Investment Account?",
        #                 'options': ['10', '20', '100', '160'],
        #                 'correct': '100',
        #             },
        #             {
        #                 'question': '每期开始时，你和你的对手各自获得10份资源. 如果你和你的对手都投入5份资源到投资账户(\(x_1=x_2=5\)), 你们的合作总收益是多少? At the start of a round, you and the other participant each receive 10 points. Suppose both of you put 5 points in the Investment Account (\(x_1=x_2=5\)). What is the total return from the Investment Account?",
        #                 'options': ['5', '10', '25', '50'],
        #                 'correct': '25',
        #             },
        #             {
        #                 'question': '如果你投入3份资源到分配账户(\(y_1 = 3\)), 而你的对手投入2份资源到分配账户(\(y_2 = 2\))。你获得的合作总收益的份额是多少? Suppose you put 3 points in the Rationing Account (\(y_1 = 3\)), and the other participant put 2 points in the Rationing Account (\(y_2 = 2\)). What is your share of the total return from the Investment Account? ",
        #                 'options': ['0.4', '0.5', '0.6', '1'],
        #                 'correct': '0.6',
        #             },
        #         ]
        ...
        #             },
        #             {
        #                 'question': '每期开始时，你和你的对手各自获得10份资源. 如果你和你的对手都投入10份资源到投资账户(\(x_1=x_2=10, y_1=y_2=0\)), 你们的合作总收益是多少? At the start of a round, you and the other participant each receive 10 points. Suppose both of you put all the 10 points in the Investment Account (\(x_1=x_2=10, y_1=y_2=0\)). What is the total return from the Investment Account?",
        #                 'options': ['10', '20', '100', '160'],
        #                 'correct': '160',
        #             },
        #             {
        ...
        #         questions = [
        #             {
        #                 'question': '[True/False] 每期开始时，玩家A拥有20份资源，玩家B拥有10份资源. At the start of each round, Player A receives 20 points and Player B receives 10 points.',
        #                 'options': ['True', 'False'],
        #                 'correct': 'True',
        #             },
        #             {
        ...
        #             },
        #             {
        #                 'question': '如果你和你的对手将全部资源都投入到投资账户(\(x_A=20, x_B=10, y_A=y_B=0\)), 你们的合作总收益是多少? Suppose both players put all points in the Investment Account (\(x_A=20, x_B=10, y_A=y_B=0\)). What is the total return from the Investment Account?",
        #                 'options': ['10', '20', '100', '150'],
        #                 'correct': '100',
        #             },
        #             {
        #                 'question': ' 如果你和你的对手都投入10份资源到投资账户(\(x_A=x_B=10\)), 你们的合作总收益是多少? Suppose both players put 10 points in the Investment Account (\(x_A=x_B=10\)). What is the total return from the Investment Account?",
        #                 'options': ['10', '20', '50', '100'],
        #                 'correct': '50',
        #             },
        #             {
        #                 'question': '如果你投入10份资源到投资账户而你的对手将投入0份资源到投资账户，你们的合作总收益是多少? Suppose you put 10 points in the Investment Account, while the other put 0 point. What is the total return from the Investment Account?',
        #                 'options': ['0', '10', '20', '50'],
        #                 'correct': '0',
        #             },
        #             {
        #                 'question': '如果你投入3份资源到分配账户(\(y_1 = 3\)),，而你的对手投入2份资源到分配账户(\(y_2 = 2\))。你获得的合作总收益的份额是多少? Suppose you put 3 points in the Rationing Account, and the other participant put 2 points in the Rationing Account. What is your share of the total return from the Investment Account?",
        #                 'options': ['0.4', '0.5', '0.6', '1'],
        #                 'correct': '0.6',
        #             },
        #         ]
    ...
    def before_next_page(self):
        ...
        self.participant.vars['qualified'] = True
